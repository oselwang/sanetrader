...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.0.5/sweetalert2.min.css" media="all"/>
                    ...
                    <div class="col-md-8 col-sm-7 col-xs-12">
                        <div class="header-info pull-right">
                            <div class="header-info-search">
                                <a href="#" class="header-btn-video"><span class="lnr lnr-camera-video"></span>
                                    videos</a>
        ...
        <div id="footer">
            <div class="footer-default">
                ...
                <div class="footer">
                    ...
                    <p class="copyright" style="font-size: 13px; margin-top: 5px; margin: 0 0 10px; line-height: 22px;">
                        Copyright © 2016 Wordpress. All Rights Reserved. Designed by <a href="#"><span>7uptheme</span>.com</a>.
                    </p>
                </div>
            </div>
        </div>
...
@else
    <script type="text/javascript"
            ...
            data-client-key="VT-client-En3LB3UmbfMzXn-M"></script>
@endif
<script type="text/javascript">
    var payButtonMonthly = document.getElementById('cd-select-monthly');
    var payButtonYearly = document.getElementById('cd-select-yearly');
    function fetchSnapToken(price) {
        $.ajax({
            type: 'post',
            url: 'snap/token',
            data: {
            ...
            success: function (data) {
                snap.pay(data); // (nanti tolong uncomment ya lik :D //store your snap token here
            },
    ...
    payButtonMonthly.addEventListener('click', function () {
        fetchSnapToken(35);
    });

    payButtonYearly.addEventListener('click', function () {
        fetchSnapToken(350);
    });
</script>
</body>
